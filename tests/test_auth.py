...
from grocery_mart_api.clock_helpers.constants import SHOPEE_ORDER_STATUS_ENUM
from unittest.mock import Mock, patch
import json


@patch('grocery_mart_api.auth.namespaces.auth.system.generate_access_token')
...
@patch('grocery_mart_api.auth.namespaces.auth.q.enqueue_call')
@patch('grocery_mart_api.auth.namespaces.auth.shop.get_shop_info')
